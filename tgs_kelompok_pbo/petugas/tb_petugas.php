...
<body>
            ...
            <tbody>
                ...
                while( $baris = mysqli_fetch_row($hasil_mysql))
                {
                    ...
                    <tr>
                        ...
                        <td><?=$baris[2]?></td>
                        <td>
                            <a href="edit-petugas.php?id=<?=$baris[0]?>" class="btn btn-primary btn-sm"><i class="fa fa-edit">edit</i></a>
                            <a href="delete-petugas.php?id=<?=$baris[0]?>" class="btn btn-danger btn-sm"><i class="fas fa-trash">delete</i></a>
                        </td>
                    </tr>
                    <?php
                }
    ...
    <br>
    <center>
        <button align="center"><a href="index.php">Form Petugas</a></button>
    </center>
